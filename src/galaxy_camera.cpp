...
namespace galaxy_camera {
    ...
    GalaxyCamera::GalaxyCamera(const ros::NodeHandle &nh,
        ...
        // Set device pixel format to BayerRG12 to preserve dynamic range
        assert(GXSetEnum(dev_handle_, GX_ENUM_PIXEL_FORMAT, GX_PIXEL_FORMAT_BAYER_RG12) == GX_STATUS_SUCCESS);
